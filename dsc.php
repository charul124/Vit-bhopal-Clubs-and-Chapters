...
<section class="gallery" id="gallery">
   ...
   <u><h1 class="heading" style="color: blue">Data Science Club</h1></u>

    <div class="box-container">

        <h3 style="font-style: bold; font-size: 30px;">Faculty Coordinator: </h3>
        <h3 style="font-style: bold; font-size: 30px;">Dr. Abha Trivedi(100259) </h3>
        <br>
        <h3 style="font-style: bold; font-size: 30px;">Room no.: C-530</h3>
        <h3 style="font-style: bold; font-size: 30px;">Mobile Number / Mail ID: </h3>
        <h3 style="font-style: bold; font-size: 30px;">7607537134 / abhatrivedi2021@vitbhopal.ac.in</h3>
        <h3>     </h3>
...
<section class="gall" id="gall">
    ...
    <div class="box-container">
        ...
        <h3 style="font-style: bold; font-size: 30px;">Dr. Pon Harshavardhan (100122)</h3>
        <br>
        <h3 style="font-style: bold; font-size: 30px;">Room no.: FC202 </h3>
        <h3 style="font-style: bold; font-size: 30px;">Mobile Number / Mail ID: </h3>
        <h3 style="font-style: bold; font-size: 30px;">9840768153 / pon.harshavardhanan@vitbhopal.ac.in</h3>
...
<section class="gall" id="gall">
    ...
    <div class="box-container">
        ...
        <u style="font-style: bold; font-size: 30px;"><h3 style="color: blue">Google-form link for registration purpose: </h3></u>
