...
<section class="gallery" id="gallery">
   ...
   <u><h1 class="heading" style="color: blue">Drama Club</h1></u>

    <div class="box-container">

        <h3 style="font-style: bold; font-size: 30px;">Faculty Coordinator: </h3>
        <h3 style="font-style: bold; font-size: 30px;">Sumit Mittal (100083) </h3>
        <br>
        <h3 style="font-style: bold; font-size: 30px;">Room no.: FC-313-B</h3>
        <h3 style="font-style: bold; font-size: 30px;">Mobile Number / Mail ID: </h3>
        <h3 style="font-style: bold; font-size: 30px;">9318325748 / sumit.mittal@vitbhopal.ac.in</h3>
        <h3>     </h3>
...
<section class="gall" id="gall">
    ...
    <div class="box-container">
        ...
        <h3 style="font-style: bold; font-size: 30px;">Dr. Rabia Musheer(100078)</h3>
        <br>
        <h3 style="font-style: bold; font-size: 30px;">Room no.: FC-408-B </h3>
        <h3 style="font-style: bold; font-size: 30px;">Mobile Number / Mail ID: </h3>
        <h3 style="font-style: bold; font-size: 30px;">9479967401/rabia.musheer@vitbhopal.ac.in</h3>
