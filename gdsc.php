...
<section class="gallery" id="gallery">
   ...
   <u><h1 class="heading" style="color: blue">Google Developer Student Clubs</h1></u>
   <br>
            <br>
            <br>
            <br>
    ...
    <div class="box-container">
        ...
        <h3 style="font-style: bold; font-size: 30px;" >Dr. Kamlesh Chandravanshi (100360) </h3>
        <br>
        <br>
        <h3 style="font-style: bold; font-size: 30px;" >Room no.: 4B</h3>
        <h3 style="font-style: bold; font-size: 30px;" >Mobile Number / Mail ID: </h3>
        <h3 style="font-style: bold; font-size: 30px;" >9009217763 / kamlesh.chandravanshi@vitbhopal.ac.in</h3>
...
<section class="gall" id="gall">
    ...
    <div class="box-container">
        ...
        <h3 style="font-style: bold; font-size: 30px;" > Dr. Gaurav Soni (100382)</h3>
        <h3 style="font-style: bold; font-size: 30px;" >Room no.: FC-408-B </h3>
        <h3 style="font-style: bold; font-size: 30px;" >Mobile Number / Mail ID: </h3>
        <h3 style="font-style: bold; font-size: 30px;" >9826018671 / gaurav.soni@vitbhopal.ac.in</h3>
...
<section class="gall" id="gall">
    ...
    <div class="box-container">
        ...
        <u><h3 style="color: blue; font-size: 30px;">Google-form link for registration purpose: </h3></u>
        <a href="https://docs.google.com/forms/d/e/1FAIpQLScomi1BKOx2-VHOQRAZwfev_-MxhLjPEhFFs2-Ywut32y8oHQ/viewform?usp=sf_link"><h3>Click here for Recruitments and Registrations</h3></a>
