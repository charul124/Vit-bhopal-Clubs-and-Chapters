...
<nav style="background-color: #192041; height: 100px; padding: 1.5rem 10rem;">
  ...
  <div style="font-size : 17px;font-family:'Abyssinica SIL', serif;text-align: center;" class="menu">    
    <a  href="welcome.php"style="padding:5px ;">Home</a>
    <a  href="https://www.youtube.com/watch?v=C-KbCMvt86A" target="_blank" style="padding:5px ;">About</a>
    <a  href="login.php" style="padding:5px ;">Admin Login</a>
    <a  href="login2.php"style="padding:5px ;">User Login</a>
    <a  href="Signup.php"style="padding:5px ;">User Sign up</a>
    <a  href="event.html"style="padding:5px ;">Events</a>
    <a  href="clubs.php"style="padding:5px ;">Clubs & Chapters</a>
  </div>
</nav>  
...
<section class="gallery" id="gallery">
   ...
   <u><h1 class="heading" style="color: blue">AI Club</h1></u>

    <div class="box-container">

        <h3 style="font-style: bold; font-size: 30px;">Faculty Coordinator: </h3>
        <h3 style="font-style: bold; font-size: 30px;"> Dr. A V R Mayuri (100255) </h3>
        <br>
        <h3 style="font-style: bold; font-size: 30px;">Room no.: B-313</h3>
        <h3 style="font-style: bold; font-size: 30px;">Mobile Number / Mail ID: </h3>
        <h3 style="font-style: bold; font-size: 30px;">9441438843 / mayuri.avr@vitbhopal.ac.in</h3>
        <h3>     </h3>
...
<section class="gall" id="gall">
    ...
    <div style="font-style: bold; font-size: 30px;"  class="box-container">

        <h3 style="font-style: bold; font-size: 30px;">Faculty co-Coordinator: </h3>
        <h3 style="font-style: bold; font-size: 30px;"> Dr. Suthir S (100251)</h3>
        <h3 style="font-style: bold; font-size: 30px;">Room no.: C-525 </h3>
        <h3 style="font-style: bold; font-size: 30px;"style="font-style: bold">Mobile Number / Mail ID: </h3>
        <h3 style="font-style: bold; font-size: 30px;">9944042932 / suthir.s@vitbhopal.ac.in</h3>

    </div>

</section>

<section style="font-style: bold; font-size: 30px;"  class="gall" id="gall">


    <div class="box-container">

        <u><h3 style="color: blue;font-style: bold; font-size: 30px;">Google-form link for registration purpose: </h3></u>
        <a href="https://docs.google.com/forms/d/e/1FAIpQLScomi1BKOx2-VHOQRAZwfev_-MxhLjPEhFFs2-Ywut32y8oHQ/viewform?usp=sf_link"><h3 style="font-style: bold; font-size: 30px;">Click here for Recruitments and Registrations</h3></a>
