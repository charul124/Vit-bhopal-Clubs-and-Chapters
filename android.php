  ...
  <div style="font-size : 17px;font-family:'Abyssinica SIL', serif;text-align: center;" class="menu">    
    ...
    <a  href="clubs.php"style="padding:5px ;">Clubs & Chapters</a>
        ...
        <section class="gallery" id="gallery">
            ...
            <u>
                <h1 class="heading" style="color: blue">Android Club</h1>
            </u>
            <br>
            <br>
            <br>
            ...
            <div class="box-container">
                ...
                <h3 style="font-size: 30px;" >Mr. G.Ganeshan(100377)</h3>
                <br>
                <h3 style="font-style: bold; font-size: 30px;">Room no.: A-303</h3>
                <h3 style="font-style: bold; font-size: 30px;">Mobile Number / Mail ID: </h3>
                <h3 style="font-style: bold; font-size: 30px;">9500234437 / ganesan.g@vitbhopal.ac.in</h3>
                <h3> </h3>
        ...
        <section class="gall" id="gall">
            ...
            <div class="box-container">
                ...
                <h3 style="font-style: bold; font-size: 30px;" >Faculty Co-Coordinator: </h3>
                <h3 style="font-style: bold; font-size: 30px;" >Dr.Varshali Jaiswal(100362)</h3>
                <br>
                <h3 style="font-style: bold; font-size: 30px;" >Room no. : 3A </h3>
                <h3 style="font-style: bold; font-size: 30px;" >Mobile Number / Mail ID: </h3>
                <h3 style="font-style: bold; font-size: 30px;" >8871203298/ varshali.jaiswal@vitbhopal.ac.in</h3>
